...
class _AlertDialogScreenState extends State<AlertDialogScreen> {
  ...
  Future<void> _initializeTelephonyCheck() async {
    ...
    debugPrint(
      'Estado permisos SMS en Dialog: SMS - $smsStatus, Teléfono - $phoneStatus',
    );
  ...
  void _respondYes() {
    ...
    if (mounted) {
      ...
      alertSystemProvider
          .resetAlertTimer(); // This restarts the appropriate timer
    }
    // Pop the dialog
  ...
  Future<bool> _checkSMSPermissions() async {
    ...
    final phoneStatus = await Permission.phone.status;
    debugPrint(
      'Checking permissions before sending SMS: SMS - $smsStatus, Teléfono - $phoneStatus',
    );
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          // Avoid content going under system bars
          child: Center(
              ...
              child: Column(
                ...
                children: [
                  const Icon(
                    ...
                    color:
                        AppTheme
                            .primaryWhite, // Use white color from your theme
                    size: 80,
                  ),
                  ...
                  : */
                  Row(
                    // Always show buttons now, unless you add a different state
                    mainAxisAlignment:
                        MainAxisAlignment
                    ...
                    children: [
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  AppTheme
                                      .secondaryGreen, // Green color from theme
                      ...
                      Expanded(
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed:
                                _respondNo, // This now only pops the dialog
                            style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  AppTheme.secondaryRed, // Red color from theme
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(
                                  50,
                                ), // Rounded corners
